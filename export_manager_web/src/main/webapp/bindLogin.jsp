    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            ...
            <div class="login-box-body">
                ...
                <form action="/bindLogin.do" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-4">
                            <button type="submit" class="btn btn-primary btn-block btn-flat">绑定用户</button>
                        </div>
                    </div>
                </form>
                <div class="social-auth-links text-center">
                    ...
                    <a href="./login.jsp" class="btn btn-block btn-social btn-google btn-flat"></i>账户密码登录</a>
                </div>
            </div>
        </div>
